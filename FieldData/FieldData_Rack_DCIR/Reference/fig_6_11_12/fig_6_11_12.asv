...
for i_folder = 1:length(folders_ch)
    load(['G:\공유 드라이브\Battery Software Lab\Projects\KEPCO_ATB_Lab\ESS_Data_Preprocessing\FieldData\FieldData_Rack_DCIR\Reference\Charge\Folder' folders_ch{i_folder} '\Raw.mat']) 
