...
function createYearlyCorrectedVisualization(saveDir)
    ...
    corrected_data.R1s_uncorrected = all_R1s_uncorrected;
    corrected_data.R1s_corrected = all_R1s_corrected;
    corrected_data.T = all_T;
    corrected_data.years = all_years;
    corrected_data.yearly_models = yearly_models;
    
    save(fullfile(saveDir, 'Temperature_Corrected_R1s_Data.mat'), 'corrected_data', '-v7.3');
    fprintf('Temperature corrected data saved to: Temperature_Corrected_R1s_Data.mat\n');
