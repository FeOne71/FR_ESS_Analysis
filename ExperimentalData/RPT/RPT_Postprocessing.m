...
% saveDir   = 'G:\공유 드라이브\Battery Software Lab\0_Group Meeting\개인별_미팅자료\정철원\Experimental Data\RPT\RPT_Postprocessing';
if ~exist(saveDir,'dir'); mkdir(saveDir); end

channels = {'Ch9'}; % , 'Ch10', 'Ch11', 'Ch12', 'Ch13', 'Ch14', 'Ch15', 'Ch16'};
rpt_cycles = {'0cyc', '200cyc'};%, '400cyc'};
rpt_cycles_fields = {'cyc0', 'cyc200'}; %, 'cyc400'}; % For field names
...
% 2. OCV
fprintf('\n=== OCV Processing ===\n');
% ocvFolder = fullfile(saveDir, 'OCV');
...
% Compute mean capacity across channels for RPT0 and RPT200 (for OCV-Q)
cap_list_rpt0 = [];
cap_list_rpt200 = [];
for ch_idx = 1:length(channels)
    channel = channels{ch_idx};
...
matSaveFile = fullfile('D:\JCW\Projects\KEPCO_ESS_Local\ExperimentalData\RPT', 'RPT_processed_data.mat');
save(matSaveFile, 'OCV_data', '-append');
